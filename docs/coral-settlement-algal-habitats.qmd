...
|-----------|-------------|--------------|-------------|-------------|
| All algae   | -1/2              | -1/3                  | -1/2             | -1/2                 |
| No algae    | 1/2               | 1                     | 0                | 1                    |
| Only canopy | -1/2              | -1/3                  | -1/2             | -1/2                 |
| Only mat    | 1/2               | -1/3                  | 1                | 0                    |
...
# Model 14 - Recruits ~ Density + Coral diversity
...
```{r}
#| echo: false
read.delim(file = '../output/tables/M14Output.txt', sep = ',')
```
