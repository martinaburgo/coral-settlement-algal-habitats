...
knitr::read_chunk('../R/recruits_analysis.R')
knitr::read_chunk('../R/benthic_analysis.R')
```
...
## Exploratory data analysis
![EDA: Coral class sizes across different Sargassum heights](../output/figures/EDA_natural_juvs.png)
...
```{r}
#| echo: false
read.delim(file = '../output/tables/MN2Output.txt', sep = ',')
```


![](../output/figures/MN2_height.png)
